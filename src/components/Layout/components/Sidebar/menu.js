export const menu = [
	...
	},
	{
		...
		submenu: [
			{ id: "films", title: "Альбомы", link: "/films", icon: "play-circle", lang: false, access: ["admin", "moderator", "super_admin"] },
	...
	},
	{
		...
		access: ["admin", "moderator", "super_admin"],
		submenu: [
			{ id: "films", title: "Альбомы", link: "/films/stats", icon: "play-circle", lang: false, access: ["admin", "moderator", "super_admin"] },
	...
	},
	{
		...
		submenu: [
			{ id: "foreingUser", title: "Глобальные", link: "/foreign-user", icon: "globe", access: ["admin", "moderator", "super_admin"] },
			{ id: "contact", title: "Локальные", link: "/users", icon: "user", access: ["admin", "moderator", "super_admin"] },
			{
				id: "spisalice",
				link: "/spisalice",
				title: "Специалисты",
...

	{
		...
		link: "/partners",
		icon: "hard-drive",
		access: ["super_admin", "bookkeeping", "partner"],
		submenu: [
...

	{
		...
		submenu: [
			...
			{ id: "types", title: "Типы медиаконтента", link: "/types", icon: "type", lang: false, access: ["admin", "super_admin"] },
			{ id: "categories", title: "Категории медиаконтента", link: "/categories", icon: "list", lang: false, access: ["admin", "super_admin"] },
			{ id: "genres", title: "Жанры медиаконтента", link: "/genres", icon: "compass", lang: false, access: ["admin", "moderator", "super_admin"] },
			{ id: "tags", title: "Форматы медиаконтента", link: "/tags", icon: "grid", lang: false, access: ["admin", "super_admin"] },
			{ id: "seasons", title: "Сезоны для сериалов", link: "/seasons", icon: "cast", lang: false, access: ["admin", "super_admin"] },
