...
export class All extends Component {
	...
	componentDidMount() {
		...
		if (initialLoad) {
			this.Load(entity, name, url, params, dataKey, metaKey, appendData, prependData, primaryKey, relations, infiniteScroll, onSuccess, onError, version);
		}
	}
	...
	Load = (
		...
		name,
		url,
		{ page = 1, limit = 10, sort, fields = [], include = [], filter = {}, extra = {} } = {},
		dataKey,
		metaKey,
		appendData,
		prependData,
