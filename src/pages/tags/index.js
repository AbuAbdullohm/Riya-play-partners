...
const List = ({ history, location }) => {
	...
	return (
		<>
			<Modal.Default header="Добавить формат" toggle={createModal} setToggle={setCreateModal}>
				<Create {...{ setCreateModal }} />
			</Modal.Default>
			<Modal.Default header="Изменить формат" toggle={updateModal} setToggle={setUpdateModal}>
