...
const Form = ({ isUpdate, isSubmitting, setCreateModal, setUpdateModal, values, setFieldValue }) => {
	...
	return (
		<Grid.Row gutter={1}>
			<Grid.Column xs={12}>
				<Field component={Fields.Input} name="title_uz" type="text" placeholder="Введите названия (УЗ)" label="Названия (УЗ)" />
				<Field component={Fields.Input} name="title_ru" type="text" placeholder="Введите названия" label="Названия (РУ)" />
				<Field
